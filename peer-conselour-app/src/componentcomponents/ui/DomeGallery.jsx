...
export default function DomeGallery({
  ...
  useEffect(() => {
    ...
    const ro = new ResizeObserver(entries => {
      ...
      root.style.setProperty('--overlay-blur-strength', `${overlayBlurStrength}px`);
  ...
  useEffect(() => {
    ...
    const tick = time => {
      ...
      if (!draggingRef.current && !focusedElRef.current && !openingRef.current) {
        const nextY = wrapAngleSigned(rotationRef.current.y + (autoRotateSpeed * delta) / 16.6667);
  ...
  }, [enlargeTransitionMs, interactive, unlockScroll]);
  ...
  return (
    ...
    >
      <main ref={mainRef} className="sphere-main">
        ...
        {overlayBlurStrength > 0 ? <div className="overlay overlay--blur" /> : null}
