    ...
    return (
        <AriaCalendarCell
            ...
            className={({ isDisabled, isFocusVisible, isSelectionStart, isSelectionEnd, isSelected, isOutsideMonth }) => {
                ...
                return cx(
                    "relative size-9 focus:outline-hidden",
        ...
        >
            {({ isDisabled, isFocusVisible, isSelectionStart, isSelectionEnd, isSelected, formattedDate }) => {
                ...
                return (
                    <div
                        className={cx(
                            "relative flex size-full items-center justify-center rounded-full text-xs text-secondary hover:text-secondary_hover",
                            // Disabled state.
