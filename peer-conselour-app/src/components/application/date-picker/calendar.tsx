                    ...
                    <>
                        <header className="admin-calendar-header">
                            <Button
                                ...
                                size="sm"
                                color="tertiary"
                                className="admin-calendar-nav admin-calendar-nav-prev"
                            />
                            <AriaHeading className="admin-calendar-heading text-sm font-semibold text-fg-secondary" />
                            <Button
                                slot="next"
                                iconLeading={ChevronRight}
                                size="sm"
                                color="tertiary"
                                className="admin-calendar-nav admin-calendar-nav-next"
                            />
                        </header>
                        ...
                        <AriaCalendarGrid weekdayStyle="short" className="w-max">
                            <AriaCalendarGridHeader className="border-b-4 border-transparent">
                                {(day) => {
                                    const ID_DAYS: Record<string, string> = {
                                    ...
                                    return (
                                        <AriaCalendarHeaderCell className="p-0">
                                            <div className="flex size-9 items-center justify-center text-xs font-medium text-secondary">{ID_DAYS[day] || day.slice(0, 3)}</div>
